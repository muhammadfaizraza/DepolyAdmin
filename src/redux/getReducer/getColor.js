...
export const fetchcolor = createAsyncThunk('/Colorget/fetch', async({SearchTitle,SearchCode}) => {
    const res = await axios.get(`${window.env.API_URL}/Colorget?shortCode=${SearchCode}&NameEn=${SearchTitle}&limit=${'1000'}`);
