...
export const fetchHorse = createAsyncThunk('/SearchHorse/fetch', async({SearchTitle,SearchCode,SearchAge}) => {
    const res = await axios.get(`${window.env.API_URL}SearchHorse?shortCode=${SearchCode}&NameEn=${SearchTitle}&DOB=${SearchAge}`);
